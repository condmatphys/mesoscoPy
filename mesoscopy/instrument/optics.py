...
from qcodes.utils.validators import Sequence, Ints
from qcodes.utils.helpers import create_on_off_val_mapping
os.chdir("C:\\MIRcat_laser\\src")
import MIRcatSDKConstants as sdk_constants
...
class Thorlab_PM100D(VisaInstrument):
    ...
    def __init__(self,
        ...
        """
        super().__init__(self, name, address, terminator='\n'
...
class DRSDaylightSolutions_MIRcat(Instrument):
    ...
    def __init__(self,
        ...
        self._dll = ctypes.CDLL("MIRcatSDK.dll")
        ...
        self._dll.MIRcatSDK_isInterlockedStatusSet(ctypes.byref(self._is_interlock_set))
        # check key switch status
        self._dll.MIRcatSDK_IsKeySwitchStatusSet(ctypes.byref(self._is_keyswitch_set))
        ...
        self.T1 = Parameter(
            "temperature chip 1",
            get_cmd = self._get_temperature(1),
            get_parser = float,
            unit = '°C',
            instrument = self
        )
        self.T2 = Parameter(
            "temperature chip 2",
            get_cmd = self._get_temperature(2),
            get_parser = float,
            unit = '°C',
            instrument = self
        )
        self.T3 = Parameter(
            "temperature chip 3",
            get_cmd = self._get_temperature(3),
            get_parser = float,
            unit = '°C',
            instrument = self
        )
        self.T4 = Parameter(
            "temperature chip 4",
            get_cmd = self._get_temperature(4),
            get_parser = float,
            unit = '°C',
            instrument = self
        )
        ...
        self.pulse_rate_1 = Parameter(
            "pulse rate chip 1",
            get_cmd = self._get_pulse_rate(1),
            get_parser = float,
            set_cmd = self._set_pulse_rate(chip=1),
            set_parser = float,
            unit = 'Hz',
            instrument = self
        )
        self.pulse_rate_2 = Parameter(
            "pulse rate chip 2",
            get_cmd = self._get_pulse_rate(2),
            get_parser = float,
            set_cmd = self._set_pulse_rate(chip=2),
            set_parser = float,
            unit = 'Hz',
            instrument = self
        )
        self.pulse_rate_3 = Parameter(
            "pulse rate chip 3",
            get_cmd = self._get_pulse_rate(3),
            get_parser = float,
            set_cmd = self._set_pulse_rate(chip=3),
            set_parser = float,
            unit = 'Hz',
            instrument = self
        )
        self.pulse_rate_4 = Parameter(
            "pulse rate chip 4",
            get_cmd = self._get_pulse_rate(4),
            get_parser = float,
            set_cmd = self._set_pulse_rate(chip=4),
            set_parser = float,
            unit = 'Hz',
            instrument = self
        )
        ...
        self.pulse_width_1 = Parameter(
            "pulse width chip 1",
            get_cmd = self._get_pulse_width(1),
            get_parser = float,
            set_cmd = self._set_pulse_width(chip=1),
            set_parser = float,
            unit = 's',
            instrument = self
        )
        self.pulse_width_2 = Parameter(
            "pulse width chip 2",
            get_cmd = self._get_pulse_width(2),
            get_parser = float,
            set_cmd = self._set_pulse_width(chip=2),
            set_parser = float,
            unit = 's',
            instrument = self
        )
        self.pulse_width_3 = Parameter(
            "pulse width chip 3",
            get_cmd = self._get_pulse_width(3),
            get_parser = float,
            set_cmd = self._set_pulse_width(chip=3),
            set_parser = float,
            unit = 's',
            instrument = self
        )
        self.pulse_width_4 = Parameter(
            "pulse width chip 4",
            get_cmd = self._get_pulse_width(4),
            get_parser = float,
            set_cmd = self._set_pulse_width(chip=4),
            set_parser = float,
            unit = 's',
            instrument = self
        )
        ...
        self.pulse_current_1 = Parameter(
            "pulse current chip 1",
            get_cmd = self._get_pulse_current(1),
            get_parser = float,
            set_cmd = self._set_pulse_current(chip=1),
            set_parser = float,
            unit = 'A',
            instrument = self
        )
        self.pulse_current_2 = Parameter(
            "pulse current chip 2",
            get_cmd = self._get_pulse_current(2),
            get_parser = float,
            set_cmd = self._set_pulse_current(chip=2),
            set_parser = float,
            unit = 'A',
            instrument = self
        )
        self.pulse_current_3 = Parameter(
            "pulse current chip 3",
            get_cmd = self._get_pulse_current(3),
            get_parser = float,
            set_cmd = self._set_pulse_current(chip=3),
            set_parser = float,
            unit = 'A',
            instrument = self
        )
        self.pulse_current_4 = Parameter(
            "pulse current chip 4",
            get_cmd = self._get_pulse_current(4),
            get_parser = float,
            set_cmd = self._set_pulse_current(chip=4),
            set_parser = float,
            unit = 'A',
            instrument = self
        )
    ...
    def get_idn(self):
        idparts = ['DRS Daylight Solutions', 'MIRcat', None, self._get_api_version()]
        return dict(zip(('vendor', 'model', 'serial', 'firmware'),idparts))
    
    def _get_api_version(self):
        ret = self._dll.MIRcatSDK_GetAPIVersion(
            ctypes.byref(self._major),
            ctypes.byref(self._minor),
            ctypes.byref(self._patch))
        return '{1}.{2}.{3}'.format(ret, self._major.value, self._minor.value, self._patch.value)
    ...
    def _get_status(self):
        ...
        self._dll.MIRcatSDK_IsLaserArmed(byref(is_armed))
        time.sleep(0.05)
        self._dll.MIRcatSDK_IsEmissionOn(byref(is_emitting))
    ...
    def _get_cm1(self):
        ...
        tuned_ww = ctypes.c_float()
        qcl = ctypes.c_uint8()
        ret = self._dll.MIRcatSDK_GetActualWW(
            ctypes.byref(actual_ww),
            ctypes.byref(units),
            ctypes.byref(light_valid)
        )
    ...
    def _get_pulse_rate(self, chip:int = 0):
        if chip == 0:
            units = ctypes.c_uint8()
            tuned_ww = ctypes.c_float()
            chip = ctypes.c_uint8()
    ...
    def _get_pulse_width(self, chip:int = 0):
        if chip == 0:
            units = ctypes.c_uint8()
            tuned_ww = ctypes.c_float()
            chip = ctypes.c_uint8()
    ...
    def _get_pulse_current(self, chip:int = 0):
        if chip == 0:
            units = ctypes.c_uint8()
            tuned_ww = ctypes.c_float()
            chip = ctypes.c_uint8()
    ...
    def get_pulse_parameters(self, chip:int=0):
        tup = (
    ...
    def _set_pulse_rate(self, pulse_rate:float, chip:int=0):
        if chip == 0:
            units = ctypes.c_uint8()
            tuned_ww = ctypes.c_float()
            chip = ctypes.c_uint8()
        ...
        pulse_rate_ = ctypes.c_float(pulse_rate)
        pulse_width = ctypes.c_float()
        pulse_current = ctypes.c_float()
    ...
    def _set_pulse_width(self, pulse_width:float, chip:int=0):
        if chip == 0:
            units = ctypes.c_uint8()
            tuned_ww = ctypes.c_float()
            chip = ctypes.c_uint8()
        ...
        pulse_rate = ctypes.c_float()
        pulse_width_ = ctypes.c_float(pulse_width*1e9)
        pulse_current = ctypes.c_float()
    ...
    def _set_pulse_current(self, pulse_current: float, chip:int=0):
        if chip == 0:
            units = ctypes.c_uint8()
            tuned_ww = ctypes.c_float()
            chip = ctypes.c_uint8()
        ...
        pulse_rate = ctypes.c_float()
        pulse_width = ctypes.c_float()
        pulse_current_ = ctypes.c_float(pulse_current*1e3)
    ...
    def get_limits(self, chip:int = 0) -> tuple:
        ...
        Returns:
            tuple: (pulse_rate_max (Hz), pulse_width_max (s), duty_cycle_max, current_max(A))
        """
        if chip == 0:
            units = ctypes.c_uint8()
            tuned_ww = ctypes.c_float()
        ...
        return (pulse_rate_max.value, pulse_width_max.value/1e9, duty_cycle_max.value, current_max.value/1e3)
